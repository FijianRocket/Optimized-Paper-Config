...
by Calebrimbor, please check out their guides on server optimization and lag if you want to learn about it.
...
Optimized: Values changed for optimization purposes
